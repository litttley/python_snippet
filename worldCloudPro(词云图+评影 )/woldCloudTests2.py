...
# 1、读入txt文本数据
text = open(r'D:\projects\教程目录及说明.txt', "r").read()
...
wc = WordCloud(font_path=r"D:\projects\微软雅黑.ttf", background_color='white', width=800,
               height=600, max_font_size=50,
               max_words=1000)  # ,min_font_size=10)#,mode='RGBA',colormap='pink')
wc.generate(result)
wc.to_file(r"D:\projects\wordcloud.png")  # 按照设置的像素宽高度保存绘制好的词云图，比下面程序显示更清晰
