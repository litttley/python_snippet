...
def searchData(start,num):
    ...
    try:
        ...
        req = requests.get(url='http://v6-dy.ixigua.com/video/m/220abc971e0e0684e24b101d721fab6cab31156ab6800001a5ccf9c43e3/?Expires=1532177598&AWSAccessKeyId=qh0h9TdcEMoS2oPj7aKX&Signature=gYN5tpNVget47rC1wrdknDXsvqs%3D')  # 最基本的GET请求
