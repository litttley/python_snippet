...
def searchData(start,num):
    ...
    try:
        ...
        req = requests.get(url='https://movie.douban.com/subject/1292720/comments?start='+str(start)+'&limit=20&sort=new_score&status=P&comments_only=1',headers=headers)  # 最基本的GET请求
